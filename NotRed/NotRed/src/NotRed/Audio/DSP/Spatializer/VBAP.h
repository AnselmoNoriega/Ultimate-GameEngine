...
namespace NR::Audio::DSP
{
    ...
    public:
        static bool InitVBAP(VBAPData* vbap, const size_t numOfInputs, const size_t numOfOutputs, const ma_channel* sourceChannelMap, const ma_channel* outPutChannelMap);
